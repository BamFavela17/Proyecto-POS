...
on primary
(
name = PuntoVentaCahuamanta_dat, filename = 'C:\DB\PuntoVentaCahuamanta.mdf',
size = 100MB,
maxsize = 600MB,
filegrowth = 10%
)
log on
(
name = PuntoVentaCahuamanta_log, filename = 'C:\DB\PuntoVentaCahuamanta.ldf',
size = 100MB,
maxsize = 600MB,
filegrowth = 10%
)
...
go
				...
				@preunit money
				as
				insert into Platillos(NomP,Descripcion,PrecioUnidad) values(@nom,@des,@preunit)
				go
				-- Procedimientos modificar --
				...
				@preunit money
				as
				update Platillos set NomP=@nom,Descripcion=@des,PrecioUnidad=@preunit
				where id=@id
...
go
exec insertarPlatillo 'vaso cahuamanta','vaso de 12oz con manta aleta y camaron',80
go
...
>>>>>>> a08e6fa88febdf2c6904ffd7e71526b926caeba2
